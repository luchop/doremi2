...
<?php 
echo form_open("matriculacion/ModificaMatricula/$CodMatricula",  array('id' => 'formulario', 'name' => 'formulario'));
?>
...
<div class="span-8 center last">
	<label for='Deposito'>Dep&oacute;sito </label>
	  <input type='text' id='Deposito' name='Deposito' size='10' maxlength='10' value='<?php echo $Deposito; ?>' /><br />  
</div><hr />
