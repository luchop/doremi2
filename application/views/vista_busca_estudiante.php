...
if(isset($Modificacion))
	echo form_open("estudiante/BuscaParaModificar/$Modificacion",  array('id' => 'Estudiante', 'name' => 'Estudiante'));
else
    echo form_open("estudiante/BuscaParaEliminar",  array('id' => 'Estudiante', 'name' => 'Estudiante'));
?>
